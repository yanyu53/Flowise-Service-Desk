...
const SupportWorkbench = Loadable(lazy(() => import('@/views/supportworkbench')))
const SupportCustomers = Loadable(lazy(() => import('@/views/supportcustomers')))
const SupportConversations = Loadable(lazy(() => import('@/views/supportconversations')))
const SupportWidgetPublisher = Loadable(lazy(() => import('@/views/supportwidget')))
const SupportUsage = Loadable(lazy(() => import('@/views/supportusage')))
const SupportAudit = Loadable(lazy(() => import('@/views/supportaudit')))
...
const MainRoutes = {
    ...
    children: [
        ...
        },
        {
            ...
            element: (
                <RequireAuth permission={'supportTickets:view'}>
                    <SupportTickets />
                </RequireAuth>
            )
        },
        ...
        },
        {
            ...
            element: <SupportConversations />
        },
        {
            path: '/support/widget',
            element: <SupportWidgetPublisher />
        },
        {
            path: '/support/usage',
            element: <SupportUsage />
        },
        {
            path: '/support/audit',
            element: <SupportAudit />
        },
        {
            path: '/apikey',
            element: (
