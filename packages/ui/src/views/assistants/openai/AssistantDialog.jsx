...
const AssistantDialog = ({ show, dialogProps, onCancel, onConfirm, setError }) => {
    ...
    const onDeleteClick = () => {
        setDeleteDialogProps({
            title: `删除助手`,
            description: `请选择 ${assistantName} 的删除方式`,
            cancelButtonName: '取消'
        })
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 2 }}>
                    ...
                    <Box>
                        <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                            ...
                            <TooltipWithParser title={'助手名称，最多 256 个字符。'} />
                        </Stack>
                        <OutlinedInput
                            id='assistantName'
                            type='string'
                    ...
                    <Box>
                        <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                            ...
                            <TooltipWithParser title={'助手描述，最多 512 个字符。'} />
                        </Stack>
                        <OutlinedInput
                            id='assistantDesc'
                            type='string'
                    ...
                    <Box>
                        ...
                        <OutlinedInput
                            ...
                            size='small'
                            fullWidth
                            placeholder='你是一名私人数学老师。当被提问时，请编写并运行 Python 代码来回答问题。'
                            multiline={true}
                            rows={3}
                    ...
                    <Box>
                        <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                            ...
                            <TooltipWithParser
                                title={
                                    '控制随机性：数值越低结果越稳定；接近 0 时模型会更确定且可能更重复。'
                                }
                            />
                        </Stack>
                        <OutlinedInput
                    ...
                    <Box>
                        <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                            ...
                            <TooltipWithParser
                                title={
                                    '通过核采样控制多样性：0.5 表示仅考虑累计概率约 50% 的候选项。'
                                }
                            />
                        </Stack>
                        <OutlinedInput
                        ...
                        <>
                            <Box>
                                <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                                    ...
                                    <TooltipWithParser title='助手启用的工具列表。每个助手最多可启用 128 个工具。' />
                                </Stack>
                                <MultiDropdown
                                    ...
                                    <Card sx={{ mb: 2, border: '1px solid #e0e0e0', borderRadius: `${customization.borderRadius}px` }}>
                                        <CardContent>
                                            <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                                                ...
                                                <TooltipWithParser title='代码解释器允许助手编写并运行代码，可处理多种数据/格式文件，并生成图表等文件。' />
                                            </Stack>
                                    ...
                                    <Card sx={{ mb: 2, border: '1px solid #e0e0e0', borderRadius: `${customization.borderRadius}px` }}>
                                        <CardContent>
                                            <Stack sx={{ position: 'relative', alignItems: 'center' }} direction='row'>
                                                ...
                                                <TooltipWithParser title='文件检索让助手可以利用你/用户上传的文件知识。上传后，助手会根据用户请求自动决定何时检索内容。' />
                                            </Stack>
