    ...
    return (
        <React.Fragment>
            <StyledTableRow hover sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                ...
                <StyledTableCell>{!props.row.lastLogin ? '从未' : moment(props.row.lastLogin).format('DD/MM/YYYY HH:mm')}</StyledTableCell>
                <StyledTableCell>
                        ...
                        <Table aria-label='assigned roles table'>
                            ...
                            >
                                <TableRow>
                                    ...
                                    <StyledTableCell sx={{ width: '50%' }}>工作区</StyledTableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
...
const Users = () => {
    ...
    const deleteUser = async (user) => {
        const confirmPayload = {
            title: '删除',
            description: `确认将 ${user.name ?? user.email} 从组织中移除吗？`,
            ...
            <MainCard>
                {error ? (
                    ...
                    <Stack flexDirection='column' sx={{ gap: 3 }}>
                        <ViewHeader onSearchChange={onSearchChange} search={true} searchPlaceholder='搜索用户' title='用户管理'>
                                            ...
                                            <Table sx={{ minWidth: 650 }} aria-label='users table'>
                                                ...
                                                >
                                                    <TableRow>
                                                        ...
                                                        <StyledTableCell>邮箱/姓名</StyledTableCell>
                                                        <StyledTableCell>分配角色</StyledTableCell>
                                                        <StyledTableCell>状态</StyledTableCell>
                                                        <StyledTableCell>最近登录</StyledTableCell>
                                                        <StyledTableCell> </StyledTableCell>
                                                    </TableRow>
                                                </TableHead>
                                                <TableBody>
