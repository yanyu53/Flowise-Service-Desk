...
const Documents = () => {
    ...
    const deleteDocumentStore = () => {
        ...
        let description = `确认删除文档库 [${documentStoreToDelete.name}] 吗？此操作会将其从列表中移除。`
        ...
        if (
            ...
            description = `确认删除文档库 [${documentStoreToDelete.name}] 吗？此操作会将其从列表中移除，并删除向量数据库中的实际数据。`
        }
            ...
            {error ? (
                ...
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    <ViewHeader
                        ...
                        title='文档库'
                        description='存储并写入文档，用于 LLM 检索（RAG）'
                    >
                        {hasDocStores && (
                            <ToggleButtonGroup
