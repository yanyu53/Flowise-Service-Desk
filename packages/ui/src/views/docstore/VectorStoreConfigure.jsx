...
const VectorStoreConfigure = () => {
    ...
    const getLoaderDisplayName = (loader) => {
        ...
        const loaderName = loader.loaderName || '未知'
        let sourceName = ''
                        ...
                        {storeId && (
                            <Stack flexDirection='column' sx={{ gap: 3 }}>
                                ...
                                >
                                    ...
                                    <IconButton onClick={showUpsertHistoryDrawer} size='small' color='inherit' title='写入历史'>
                                        <IconClock />
                                    </IconButton>
                                </ViewHeader>
                                <Steps />
